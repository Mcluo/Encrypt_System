...
public class encrypt_frame extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					Object[] option = { "加密", "解密" };
					int Option = JOptionPane.showOptionDialog(frame, "初始化选择：请选择你想进行的操作", "提示",
							JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE, null, option, option[0]);
					if (Option == 0)
	...
	public encrypt_frame() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
				"\u52A0\u5BC6/\u89E3\u5BC6\u6587\u4EF6\u8F93\u5165", TitledBorder.LEADING, TitledBorder.TOP, null,
				new Color(0, 0, 0)));
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addComponent(panel_3, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)
						.addComponent(panel_1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)
						.addComponent(panel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE))
				.addContainerGap())
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						.addComponent(Enc_Btn, GroupLayout.PREFERRED_SIZE, 110, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(createkey_Btn)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(reset_Btn, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED, 36, Short.MAX_VALUE)
						.addComponent(Exit_Btn, GroupLayout.PREFERRED_SIZE, 110, GroupLayout.PREFERRED_SIZE).addGap(42))
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(Exit_Btn)
						.addComponent(Enc_Btn).addComponent(createkey_Btn).addComponent(reset_Btn))
				.addContainerGap()));
		...
		gl_panel_3.setHorizontalGroup(gl_panel_3.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_3
				...
				.addGroup(gl_panel_3.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_3.createSequentialGroup()
						.addComponent(lblDes_2, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE).addGap(6)
						...
						.addGroup(gl_panel_3.createSequentialGroup()
								...
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(AESKeyConfirm,
										GroupLayout.PREFERRED_SIZE, 191, GroupLayout.PREFERRED_SIZE)))
				.addGap(18).addComponent(label_2, GroupLayout.PREFERRED_SIZE, 154, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel_3.createSequentialGroup()
								.addGroup(gl_panel_3.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panel_3.createSequentialGroup().addGap(5).addComponent(lblDes_2,
												GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE))
										.addComponent(AESKey_text, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addGap(13)
								.addGroup(gl_panel_3.createParallelGroup(Alignment.BASELINE)
										.addComponent(AESKeyConfirm, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addComponent(lblDes_1_1, GroupLayout.PREFERRED_SIZE, 15,
												GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_panel_3.createSequentialGroup().addComponent(label_2).addGap(23)))
				.addGap(22)));
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_1
				...
				.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_1.createSequentialGroup()
								...
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(DESKeyConfirm_text,
										GroupLayout.PREFERRED_SIZE, 191, GroupLayout.PREFERRED_SIZE)))
				.addContainerGap(60, Short.MAX_VALUE)));
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(DESKey_text, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblDes_1, GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE)
								.addComponent(DESKeyConfirm_text, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)))
				.addGroup(gl_panel_1.createSequentialGroup().addGap(26).addComponent(label)));
	...
	public static void run() {
		try {
			...
			frame.setVisible(true);
			Object[] option = { "加密", "解密" };
			int Option = JOptionPane.showOptionDialog(frame, "初始化选择：请选择你想进行的操作", "提示", JOptionPane.YES_NO_CANCEL_OPTION,
